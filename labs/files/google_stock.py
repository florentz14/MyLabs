...
# Place your export here (or pass --file); same name as typical course downloads
#/home/florentino/Downloads/Google_Stock_Market_Data.xlsx
DEFAULT_STOCK_FILE = "Google_Stock_Market_Data.xlsx"

# Column names after normalization (strip + lower + spaces -> underscore)
...
def load_stock_excel(file_path: Path, sheet_name: int | str = 0) -> pd.DataFrame:
    ...
    # Map common variants for "Adj Close"
    ...
    # Parse dates and numeric fields safely
...
def main() -> None:
    ...
    # Drop rows with invalid dates or all-OHLC missing
    before = len(df)
